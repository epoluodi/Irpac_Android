...
//        Log.e("webview 内核",String.valueOf(CordovaResourceApi.getUriType(uri)));
        if (CordovaResourceApi.getUriType(uri) ==   CordovaResourceApi.URI_TYPE_STEREO) {
            return true;
        }
//        if (CordovaResourceApi.getUriType(uri) != CordovaResourceApi.URI_TYPE_HTTPS ) {
//
//
//
//            return false;
